...
import 'package:rec_coop_app/data/datasources/mock_register_data_source.dart';
import 'package:rec_coop_app/data/repositories/register_repository.dart';
...
class RegisterPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    create: (_) => RegisterController(
      RegisterRepository(MockRegisterDataSource(MockDatabase())),
    ),
    child: Scaffold(
